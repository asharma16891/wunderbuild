...
<section class="pricing-selector section-global">
        ...
        <?php if ($monthly_cards) : ?>
            ...
            <div
                ...
                <?php foreach ($monthly_cards as $card) : ?>
                    ...
                    <div
                        class="wb-card-white wb-card--small pricing-card <?php echo $is_highlighted ? 'active' : ''; ?>"
                        data-plan="<?php echo esc_attr($plan_slug); ?>">

                        <?php if (!empty($card['badge'])) : ?>

                            <h3 class="plan-name type-h6">
                       ...
                       <div class="price type-h3">
    <sup>$</sup><?php echo esc_html($card['price'] ?? ''); ?><?php if (!empty($card['price_suffix'])) : ?><small><?php echo esc_html($card['price_suffix']); ?></small><?php endif; ?>
</div>


                        <?php if (!empty($card['description'])) : ?>

                            <p class="plan-desc common-para">
