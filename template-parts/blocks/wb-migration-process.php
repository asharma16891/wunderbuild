...
<section
    class="wb-migration-process section-global"
                    ...
                    <div class="wb-migration-process__steps">
                        ...
                        <?php foreach ($migration_steps as $index => $step) : ?>
                            ...
                            >
                                ...
                                <span class="wb-migration-process__number type-p3">
                                ...
                                <?php if ($title) : ?>
                                    ...
                                    <span class="wb-migration-process__name type-p3">
                    ...
                    >
                        ...
                        <div class="wb-migration-process__card-content">
                            ...
                            <?php if ($step_label) : ?>
                                ...
                                <span class="wb-migration-process__card-label type-p3">
                    ...
                    >
                        ...
                        <div class="wb-migration-process__mobile-card">
                            ...
                            <?php if ($step_label) : ?>
                                ...
                                <span class="wb-migration-process__mobile-label type-p3">
                                    <?php echo esc_html($step_label); ?>
                                </span>
